...
Entering post-retirement, I found myself with enough time on my hands to start
volunteering for political campaigns and causes I felt strongly aligned with. I built a
prototype contact-targeting tool -- a Google Sheets extension on the
[Google Apps Script](https://en.wikipedia.org/wiki/Google_Apps_Script) (GAS) platform
-- for [Dr. Butch Ware](https://en.wikipedia.org/wiki/Butch_Ware)'s California
gubernatorial campaign. Although I never finished it (sorry, Dr. Ware!), pieces of it
are now being decomposed into our
[GAS application development platform](/projects.html#developer-tools) project.

## Getting On the AI Highway

I took away two key realizations from this experience. First, although I was never
very good with JavaScript and web UIs, I found that -- using AI -- I could now write
code at this level of the stack faster, to higher quality, and better aligned with
documentation than I ever could in my days as a low-level data pipeline plumber. What a
rush! (And yes, I know: data centers, water, electricity, evil, bad -- a future post
will address this.)
...
large part of that motivation was spurred on by my absolute revulsion at seeing my
country being run by Epstein-class ghouls, and my tax money squandered and sent to
fund the immoral slaughters of innocents in Gaza.

All of this really disturbed me as US citizen, and as 
a Jew (admittedly, not a very good one, but still a
card-carrying member). I started gradually realizing that my identity had been -- in
the phrasing of [Rabbi Yakov Schapiro](https://www.youtube.com/watch?v=kX8AuH7WWxM) --
hijacked by Zionism.
