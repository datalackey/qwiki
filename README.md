...
models). No docker required. CI runs this on every push and pull request; the
docker-based [end-to-end test](#end-to-end-test) is run manually.
...
[`@datalackey/typescript-build-config`][tbc]. Its postinstall copies the
...
[`@datalackey/autogen-markdown-doc`][autogen-markdown-doc].
After changing section headings, regenerate it with:
